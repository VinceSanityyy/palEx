  ...
  <div>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index3.html" class="brand-link">
        <img src="https://i.pinimg.com/originals/ad/ca/08/adca082427894069f92dd11fda3d96cb.gif" alt="AdminLTE Logo"
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <router-link to="/vendor/products" class="nav-link"
                :class="$route.path == '/vendor/products' ? 'active' : ''">
                <i class="nav-icon fas fa-boxes"></i>
                <p>Products</p>
              </router-link>
            </li>
            <li class="nav-item">
              <router-link to="/vendor/orders" class="nav-link"
                :class="$route.path == '/vendor/orders' ? 'active' : ''">
                <i class="nav-icon fas fa-file-invoice"></i>
                <p>Orders</p>
              </router-link>
            </li>
            <li class="nav-item">
              <router-link to="/vendor/chat" class="nav-link"
                :class="$route.name == 'ven-chat' || $route.name == 'ven-chat-id' ? 'active' : ''">
                <i class="nav-icon fas fa-comments"></i>
                <p>Chat</p>
              </router-link>
            </li>
            <li class="nav-item">
              <router-link to="/vendor/settings" class="nav-link"
                :class="$route.name == 'vendor-settings' ? 'active' : ''">
