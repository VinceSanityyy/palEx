...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
      <a href="#" class="navbar-brand">
        ...
        <span class="brand-text font-weight-light">Pal Ex</span>
      </a>
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
		...
		<li class="nav-item">
            <router-link to="/customer/feeds" class="nav-link">
			<p>Feeds</p>
			</router-link>
          </li>
		  	<li class="nav-item">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright © 2014-2021 <a href="https://adminlte.io">PalEx</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
