                  ...
                  <div class="chat_people">
                    <div class="chat_img" :style="WindowInnerWidth > 540 ? '' : 'float: none  !important; width: 100%  !important;'">
                      <img
                        ...
                        alt="sunil"
                        :style="WindowInnerWidth > 540 ? '' : 'width:35px !important; max-width:35px !important; height:35px !important; max-height:35px !important; '"
                      />
                    </div>
...
export default {
  ...
  computed: {
    cssVars() {
      return {
        ...
        "--palex-height": this.WindowInnerHeight - 270 + "px", //Mobile
        "--palex-height-2": this.WindowInnerHeight - 370 + "px", //Mobile
      };
    },
  },
  created() {
  ...
  methods: {
    ...
    showConversation(item) {
      this.$events.fire("LoadingOverlayShow");
      window.location.href = `/vendor/chat/${item.id}`;
    },
  },
};
</script>
