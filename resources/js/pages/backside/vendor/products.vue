          ...
          <div class="col-md-12">
            <div class="card card-primary card-outline">
              ...
              <div class="card-body table-responsive">
                <table id="mytableProducts" class="table table-bordered table-striped dt-responsive display nowrap">
                  <thead>
                    <tr>
                      <th>Id</th>
                      <th>Avatar</th>
                  ...
                  <tbody>
                    <tr v-for="(item, index) in products" :key="index">
                      <td>{{ item.id }}</td>
                      <td>
                        <img :src="item.image_link" alt="" style="width: 50px; height: 50px; object-fit: cover" />
                      </td>
                      <td>{{ item.name }}</td>
                      <td>{{ item.price }}</td>
                      <td>{{ item.unit }}</td>
