			...
			<div class="row">
				<div class="col-md-12">
					<div class="palex-card">
						<div class="px-2" style="font-weight: bold; font-size: 24px"><i class="fas fa-shopping-cart mr-2"></i>Cart</div>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col-lg-8 col-md-7">
                    ...
                    <el-button type="danger" icon="el-icon-delete" circle size="mini"></el-button>
						...
						<div class="d-flex justify-content-between px-2" style="color: #2c9144; font-weight: 600">
							<span> Total </span>
							<span class="mx-1"> ₱{{ frmtd(item.subtotal_with_shipping_fee) }} </span>
						</div>
					</div>
				</div>
